...
// 			echo "icons/dark-green-circle.png";
			echo $icon."hello dolly";
 			break;
 		case "Friends":
 			echo "icons/blue.png";
 			$icon="icons/dark-green-circle.png";
 		...
 		case "Girls":
 			...
 			break;
		case "School":
 			echo "icons/yellow.png";
 			$icon="icons/dark-green-circle.png";
 			break;
		case "TCC":
 			echo "icons/purple.png";
		...
		case "Travel":
 			...
 			break;
		case "Arts":
 			echo "icons/orange.png";
 			$icon="icons/orange.png";
 			break;
		case "Jobs":
 			echo "icons/green.png";
